...
const GROUPS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    label: "Intelligence",
    items: [
      { href: "/insights", label: "Voice of Customer", icon: MessageSquare, dot: "bg-teal-400" },
      { href: "/signals", label: "Competitive Signals", icon: Radar, dot: "bg-rose-400", count: 3 },
      { href: "/journeys", label: "Journey Intelligence", icon: Route, dot: "bg-blue-400" },
