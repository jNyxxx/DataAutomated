# AGENTS.md — DataAutomated.io Project Constitution
...
> **Authority:** The operating constitution for every Codex session here. A rule here is **final** unless a human maintainer approves a deviation in writing.
...
*DataAutomated.io — AGENTS.md v1.0 | June 2026 | Confidential — Engineering Use Only. Derived solely from the Product Brief v1.0 and the Technical Build Guide for Junex (the single source of truth); this file is their enforceable engineering form.*
